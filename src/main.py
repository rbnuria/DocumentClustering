...
if __name__ == "__main__":
	...
	#Aplicamos kmeans
	kmeans = KMeans(n_clusters = 20, random_state = 1234567, n_init = 25, max_iter = 500).fit(tweets)
	kmeans_tfidf = KMeans(n_clusters = 20, random_state = 1234567, n_init = 25, max_iter = 500).fit(tweets_2)
	...
	nmi_tfidf = NMI(labels_true, kmeans_tfidf.labels_)
	print(nmi_tfidf)
